...
\begin{frame}
	...
	\begin{figure}
		\resizebox{0.8\totalheight}{!}{\input{figure/gmm.tex}}
...
\begin{frame}
	...
	\begin{figure}[htb!]
	\centering
	\resizebox{0.8\totalheight}{!}{\input{figure/component.tex}}
...
\begin{frame}
	...
	\begin{figure}[htb!]
	\centering
	\resizebox{0.8\totalheight}{!}{\input{figure/eventdetectF1.tex}}
...
\begin{frame}
	...
	\begin{figure}[htb!]
	\centering
	\resizebox{0.8\totalheight}{!}{\input{figure/ourTuning.tex}}
