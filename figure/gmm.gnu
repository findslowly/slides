...
plot d1(x) lc rgb "forest-green" with filledcurves y1=0 title "$\\mu$ =  0.5 $\\sigma$ = 0.5", d2(x) lc rgb "gold" with filledcurves y1=0 title "$\\mu$ =  2.0 $\\sigma$ = 1.0", d3(x) lc rgb "dark-violet" with filledcurves y1=0 title "$\\mu$ = -1.0 $\\sigma$ = 2.0", d(x) ls 1 title "GMM"
