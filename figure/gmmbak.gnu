...
plot d1(x) lc rgb "forest-green" title "$\\mu$ =  0.5 $\\sigma$ = 0.5" fs transparent solid 0.5, d2(x) lc rgb "gold" title "$\\mu$ =  2.0 $\\sigma$ = 1.0" fs transparent solid 0.5, d3(x) lc rgb "dark-violet" title "$\\mu$ = -1.0 $\\sigma$ = 2.0" fs transparent solid 0.5, d(x) ls 1 title "GMM"
